...
public class ArrayOfDettaglioPreventivo {
    ...
    protected List<it.edison.thorGAS.DettaglioPreventivo> item;
     ...
     * {@link it.edison.thorGAS.DettaglioPreventivo }
     * 
     * 
     */
    public List<it.edison.thorGAS.DettaglioPreventivo> getItem() {
        if (item == null) {
